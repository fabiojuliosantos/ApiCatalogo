...
namespace ApiCatalogo.Controllers
{
    ...
    public class ProdutosController : ControllerBase
    {
        ...
        {
            var produtos = _context.Produtos.ToList(); //=> O contexto reconhece a tabela de produtos, e a retorna no método
        ...
        {
            var produto = _context.Produtos.FirstOrDefault(p => p.ProdutoId == id); //=> Retorna o primeiro produto com o id, caso não haja, retorna null
